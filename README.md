# Advanced Operating Systems Project 2021 #
...
Once built, you can find the executable under `/repo_dir/target/debug/aos_fat16_ext2_2021`
...
# GIT #
Git allowed me to develop this project without the worry of losing progress and to be able to keep track of the changes made. It also allowed me to rollback to a previous version of the code if need be. I also made use of branching more in this project than in the past, to test out implementations of a functionality without braking existing ones, or the whole code.